...
class RobocarPilot(object):
    '''
    Base class for Robocar models that will provide steering and throttle to guide a car.
    '''
    def __init__(self):
        self.model = None
        self.optimizer = "adam"
...
class KerasCategorical(RobocarPilot):
    '''
...
class KerasLinear(RobocarPilot):
    '''
...
class KerasBehavioral(RobocarPilot):
    '''
...
class KerasLocalizer(RobocarPilot):
    '''
...
class KerasRNN_LSTM(RobocarPilot):
...
class Keras3D_CNN(RobocarPilot):
...
class KerasLatent(RobocarPilot):
